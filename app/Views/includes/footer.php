...
<a href="tel:1666-5712" class="fixBtn fixCallBtn"><img src="/assets/img/common/fixCallBtn.svg" alt="전화연결:1666-5712"></a>
    ...
    <article class="popupContentArti">
      ...
      <div class="contentBox">
        <div class="contentBoxInner">
          본 웹사이트에 등록된 모든 내용과 게시글은 법률적 자문 또는 해석을 위해 제공되는 것이 아니며 법률사무소 트라이원스를 소개하고, 일반적인 정보 제공만을 목적으로 작성된 내용입니다.<br /><br />

          본 웹사이트에 게재된 자료상의 견해는 저자들의 개인적 의견이며, 당 소의 공식적 견해가 아님을 유념하시기 바랍니다. 웹사이트에서 취득한 정보로 인해 문제가 발생하여 직·간접적으로 손해를 입었다 하더라도 법률사무소 트라이원스와 그 구성원 전원은 어떠한 법적 책임도 지지 않음을 사전에 알려 드립니다.<br /><br />

          사건의 구체적 내용과 정황 등에 따라 이견이 있을 수 있으며, 본 웹사이트를 포함한 법률사무소 트라이원스의 저작물을 바탕으로 어떠한 조치를 취하기 이전에는 반드시 전문가와의 상담을 거쳐 진행하시기 바랍니다.<br /><br />

          법령은 시간이 경과함에 따라 변화하므로, 게시물 작성일 이후 개정되어 내용이 일치하지 않을 수 있습니다. 또한 본 웹사이트에 게재된 모든 게시물은 본 법인의 사전 동의 없이 어떠한 형태로도 복사 또는 배포, 재생 될 수 없습니다.<br /><br />

          아울러 법무법인 산음은 변호사 업무 광고 규정에 의하여 대표변호사 김주형을 광고책임 변호사로 지정하였음을 공지합니다.
        </div>
      </div>
    </article>
  </div>
...
<section class="privacyPopupSec" id="privacyPopup">
  <div class="inner">
    <article class="popupContentArti">
      <div class="titleBox">
        <p class="txt">개인정보처리 취급방침</p>
        <button type="button" class="closeBtn"><img src="/assets/img/common/popupCloseBtn.svg" alt="닫기" class="icon" /></button>
      </div>
      <div class="contentBox">
        <div class="contentBoxInner">
          법무법인 산음(이하 ‘회사’) 은(는) 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다.<br /><br />
          ...
          담당부서 : 김광석<br />
          직책 : 대표<br />
          연락처 : &lt;전화번호&gt;010-9178-9028, &lt;이메일&gt;adslovaaa@naver.com, &lt;팩스번호&gt;02)6499-3118<br />
          ※ 개인정보 보호 담당부서로 연결됩니다.<br /><br />

          ▶ 개인정보 보호 담당부서<br />
          부서명 : 마케팅부서<br />
          담당자 : 김광석<br />
          연락처 : &lt;전화번호&gt;010-9178-9028, &lt;이메일&gt;adslovaaa@naver.com, &lt;팩스번호&gt;02)6499-3118<br /><br />
...
<footer>
  <div class="inner">
    <div class="name">법무법인 산음 [836-85-01875]</div>
    <ul class="info">
      <li><dt>주소</dt><dd>인천광역시 미추홀구 소성로 166-1, 4층</dd></li>
      <li><dt>전화</dt><dd>1666-5712</dd></li>
      <li><dt>이메일</dt><dd>adslovaaa@naver.com</dd></li>
    </ul>
    <ul class="popupBtnBox">
      <li><dt>광고책임 변호사</dt><dd>김주형</dd></li>
      <li><button type="button" class="popupBtn termsBtn">면책공고</button></li>
      <li><button type="button" class="popupBtn privacyBtn">개인정보처리 취급방침</button></li>
    </ul>
    <ul class="popupBtnBox">
      <li><dt>광고대행</dt><dd>주식회사 팀트라이</dd></li>
    </ul>
    <div class="copyright">COPYRIGHT ⓒ 2025 법무법인 산음. ALL RIGHT RESERVED</div>
  </div>
</footer>
<!-- } 푸터 끝 -->
</body>
